...
<div class="mkt">
    ...
    <section class="section section--tight">
        <div class="container">
            ...
            <div class="team-grid">
                <article class="team-card"><div class="team-card__photo"><img src="<?= e(url('assets/img/randy.jpg')) ?>" alt="Randy Peay"></div><div class="team-card__body"><h3>Randy Peay</h3><div class="role">Owner &amp; Lead Painter</div><p>With over 35 years in the trade, Randy built this company on the simple belief that every job deserves the same care — whether it's a single patch or a full-building repaint. He personally oversees every project.</p></div></article>
